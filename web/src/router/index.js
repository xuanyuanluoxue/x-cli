...
const routes = [
  ...
  { path: "/tasks/new", name: "task-new", component: () => import("@/views/TaskEditView.vue"), meta: { label: "任务", parent: "tasks" } },
  { path: "/tasks/:id", name: "task-edit", component: () => import("@/views/TaskEditView.vue"), meta: { label: "任务", parent: "tasks" } },
  { path: "/secrets", name: "secrets", component: () => import("@/views/SecretListView.vue"), meta: { label: "密钥" } },
  { path: "/secrets/new", name: "secret-new", component: () => import("@/views/SecretEditView.vue"), meta: { label: "密钥", parent: "secrets" } },
  { path: "/secrets/:name", name: "secret-view", component: () => import("@/views/SecretView.vue"), meta: { label: "密钥", parent: "secrets" } },
  { path: "/secrets/:name/edit", name: "secret-edit", component: () => import("@/views/SecretEditView.vue"), meta: { label: "密钥", parent: "secret-view" } },
